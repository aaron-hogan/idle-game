...
const resourcesSlice = createSlice({
  ...
  reducers: {
    ...
    addResourceAmount: (state, action: PayloadAction<{ id: string; amount: number }>) => {
    ...
    setResourcePerSecond: (state, action: PayloadAction<{ id: string; perSecond: number }>) => {
    ...
    toggleResourceUnlocked: (state, action: PayloadAction<{ id: string; unlocked: boolean }>) => {
    ...
    updateMaxAmount: (state, action: PayloadAction<{ id: string; maxAmount: number }>) => {
    ...
    updateClickPower: (state, action: PayloadAction<{ id: string; clickPower: number }>) => {
...
// Export selectors
export const selectAllResources = (state: { resources: ResourcesState }) => state.resources.byId;

export const selectResourceIds = (state: { resources: ResourcesState }) => state.resources.allIds;
