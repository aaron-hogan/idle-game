    ...
    <div className="end-game-modal-overlay">
      <div className="end-game-modal">
        ...
        <div className="end-game-content">
          <div className="end-game-icon">{gameWon ? '🌟' : '💔'}</div>

          <p className="end-game-reason">{endReason}</p>

          {gameWon ? (
            <p className="end-game-description">
              Your movement has successfully achieved its goals and established a new, more
              equitable system! The powers of corporate oppression have been overcome through
              solidarity and collective action.
            </p>
          ) : (
            <p className="end-game-description">
              Your movement was overwhelmed by corporate opposition. The struggle continues, even
              when it faces setbacks. Remember the lessons learned and try a different strategy.
            </p>
          )}
