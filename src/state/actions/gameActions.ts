 ...
 */
export const processTick = (elapsedTime: number): AppThunk => (dispatch, getState) => {
 ...
 */
export const processOfflineProgress = (offlineTime: number): AppThunk => (dispatch, getState) => {
