...
describe('resourceUtils', () => {
  ...
  describe('calculateMaxActions', () => {
    // This test needs to use the mock store that has state.resources.resources 
    // because calculateMaxActions uses store.getState()
    beforeEach(() => {
      // Reset mocks before each test
      jest.clearAllMocks();
    });
    
    test.skip('should calculate maximum number of actions possible', () => {
      // Mock the store to return known values for testing
    ...
    test.skip('should handle zero cost resources gracefully', () => {
      // Mock the store to return known values for testing
      (store.getState as jest.Mock).mockReturnValueOnce({
        resources: {
          resources: {
